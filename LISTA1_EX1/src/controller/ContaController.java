...
public class ContaController {
    public static void main(String[] args) {
        ...
        Conta conta3 = new Conta(1000.0, 3);
        Conta conta4 = new Conta(1500.0, 5);
        Conta conta5 = new Conta(2000.0, 4);
        Conta conta6 = new Conta(800.0, 2);
        Conta conta7 = new Conta(1200.0, 1);
